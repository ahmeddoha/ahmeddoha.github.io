(function () {
  ...
  window.BUSI2301 = {
    ...
    assessments: [
      ...
      {label:"Attendance",weight:10,color:"#6c747d",detail:"Attendance is recorded electronically using the method announced in Brightspace. Bring a connected device. Full credit requires attendance at at least 11 of the 13 instructional classes and completion of the in-class check-in.",strong:"Attendance supports the worked examples and practice that turn formulas into managerial judgment. Missing more than two classes reduces the overall attendance grade by 50%."},
      {label:"Final Examination",weight:60,color:"#191919",detail:"The individual final is non-cumulative: it covers course topics not assessed in the three quizzes and includes quantitative and qualitative questions. The University publishes the schedule; Brightspace confirms delivery instructions.",strong:"Strong work chooses and executes the appropriate method, shows reasoning, checks units and assumptions, and interprets the result as an operations decision."}
    ],
    checklist: [
      ...
      "I can bring a connected device for electronic attendance and any in-class Brightspace activity."
    ],
    faq: [
      ...
      ["Where do I find Decision Theory and Linear Programming?","Supplement 5S: Decision Theory and Supplement 6S: Linear Programming are supplied through McGraw-Hill Connect; they are not in the printed textbook. Use the current Brightspace links."],
      ...
      ["How is attendance recorded?","Attendance is recorded electronically using the method announced in Brightspace. Bring a connected device. Full credit requires at least 11 of the 13 instructional classes; missing more than two classes reduces the attendance grade by 50%."],
      ...
      ["When and how is the final examination delivered?","The University publishes the final-exam date and time. Brightspace confirms the current delivery instructions. The final is individual, non-cumulative, and covers topics not assessed in the three quizzes."],
