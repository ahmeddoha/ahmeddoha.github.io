(function () {
  ...
  window.STUDENT_COURSE = {
    ...
    classes,
    assessments: [
      {label:"Attendance",weight:10,color:"#e91c24",detail:"Attend and participate in the in-class lectures, analytical activities, and both required presentation days. Attendance is registered using the university-supported system described in the official outline.",strong:"Strong participation arrives prepared, contributes to evidence-based discussion, and completes the live decision, interpretation, presentation, and peer-feedback work—not merely the attendance check."},
      {label:"Assignment 1",weight:15,color:"#c93b32",detail:"Apply the course’s AI methods to a supplied business-analytics question and dataset. Submit the report, dataset, and executable Python code together as specified in the official outline and Brightspace.",strong:"Strong work defines the decision and unit, makes the analysis reproducible, interprets examples and errors, and limits the recommendation to what the evidence supports."},
      {label:"Assignment 2",weight:15,color:"#2f6097",detail:"Complete a second applied analysis that extends the methods and evidence discipline developed later in the course. Submit the report, dataset, and executable Python code as one traceable package.",strong:"Strong work connects analytical choices to a business consequence, tests at least one consequential alternative, and explains what changed and why."},
      {label:"Term Paper",weight:50,color:"#191919",detail:"Develop a group paper around a consequential business problem using secondary data and appropriate AI methods. Submit the paper with the full dataset and Python code so the analysis can be rerun. Follow the eligibility rule and deadline in the official outline.",strong:"Strong work aligns the problem, data, method, validation, interpretation, and managerial action; documents construction choices; tests robustness; and states what additional evidence would be needed before implementation."},
      {label:"Term Paper Presentation",weight:10,color:"#69558e",detail:"Present the group term paper in class. Introduce the business problem, research question, data, AI method and code implementation, results, limitations, and decision implications within the assigned presentation time.",strong:"Strong work makes the evidence chain easy to inspect, uses analytical displays to support interpretation, and answers questions without overstating the result."}
    ],
    checklist: [
