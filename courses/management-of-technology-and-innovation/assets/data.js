(function () {
  ...
  window.BUSI4607 = {
    ...
    assessments: [
      {label:"In-Class Participation",weight:10,color:"#e91c24",detail:"Prepare every case, contribute evidence-based reasoning, and attend at least 11 of the 13 scheduled classes for full attendance credit. Attendance is recorded electronically using the method announced in Brightspace; bring a connected device for check-in. Missing more than two classes results in a 50% reduction in the overall participation grade.",strong:"Strong participation uses assigned theory and case evidence, advances the decision, and revises a position when the evidence warrants it."},
      {label:"Technology Platform Tutorial",weight:5,color:"#8b1e2d",detail:"Your team submits slides and a share link, then gives a 20-minute platform demonstration followed by a 10-minute question period. This is Presentation #1 and builds the evidence base for the term paper. Record with any current free screen-recording tool — workable options include OBS Studio, the recording built into Microsoft PowerPoint, Microsoft Clipchamp, Zoom, or QuickTime on macOS. The folder stays open after the deadline and late submissions lose 20% of the mark per day of delay.",strong:"Strong work demonstrates the product, maps its business and revenue logic, uses primary sources, identifies competition and artificial-intelligence pressures, and answers questions directly."},
      ...
      {label:"Written Term Paper",weight:40,color:"#191919",detail:"Your team writes a 10–15 page, single-spaced consulting piece, including references; exhibits, financial tables, and figures do not count toward the limit. Diagnose the platform, quantify a substantial performance gap, defend a change, and specify implementation. One member submits the paper as a Word document together with the slides; the folder stays open after the deadline and late submissions lose 20% of the mark per day of delay. Students who have not obtained at least 50% on their term work before the term paper is written are not permitted to write it and fail the course.",strong:"Strong work shows a sourced baseline, target, arithmetic, assumptions, sensitivity test, causal mechanism, second-order effects, strategic fit, leading indicators, and abandonment conditions."}
    ],
    checklist: [
    ...
    faq: [
      ["Who can take this course, and how is it delivered?","The pre-requisites are third-year standing and BUSI 2204 or BUSI 2208, with a grade of C- or higher in each. The course is delivered in class, though one or two classes might be offered on Zoom. Brightspace carries the current meeting day, time, and room."],
